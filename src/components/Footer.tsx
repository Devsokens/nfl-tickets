    ...
    <footer id="footer-contact" className="border-t border-black bg-[#0c0d0f] text-white pt-16 pb-8">
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <h4 className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#c29c38] mb-4">
              NOS SERVICES
            </h4>
          ...
          <div className="space-y-4">
            ...
            <div className="pt-2">
              <span className="text-[9px] font-bold uppercase tracking-wider text-white/40 block mb-2">
              ...
              <form onSubmit={handleNewsletterSubmit} className="relative flex items-center max-w-xs">
                <input
                  ...
                  className="w-full bg-[#16171a] border border-white/20 text-xs text-white px-3 py-2 pr-8 rounded-none focus:outline-none focus:border-[#c29c38] placeholder:text-white/30 disabled:opacity-50"
                />
                <button
                  type="submit"
                  disabled={isSubscribing}
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-[9px] text-white/40 uppercase tracking-wider">
