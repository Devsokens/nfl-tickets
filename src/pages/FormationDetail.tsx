        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5 space-y-4 text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <p className="text-white/70 text-lvl-body font-light">
              ...
              <div className="pt-3">
                <button
                  onClick={() => document.getElementById("booking-form")?.scrollIntoView({ behavior: "smooth" })}
                  className="bg-[#e3bd51] hover:bg-[#d4af37] text-black font-bold text-lvl-footer uppercase tracking-widest py-4 px-8 rounded-none transition-colors inline-flex items-center gap-3 shadow-xl"
                >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="bg-[#121418] border border-white/10 p-6 rounded-none space-y-3">
                  <div className="flex items-center gap-2.5 text-[#e3bd51]">
                    ...
                    <span className="font-bold text-lvl-footer uppercase tracking-wider text-white">LIEU DE PRESTIGE</span>
                  </div>
                  <p className="text-white/60 text-lvl-footer font-light">
                ...
                <div className="bg-[#121418] border border-white/10 p-6 rounded-none space-y-3">
                  <div className="flex items-center gap-2.5 text-[#e3bd51]">
                    ...
                    <span className="font-bold text-lvl-footer uppercase tracking-wider text-white">EXPÉRIENCE GASTRONOMIQUE</span>
                  </div>
                  <p className="text-white/60 text-lvl-footer font-light">
                ...
                <div className="bg-[#121418] border border-white/10 p-6 rounded-none space-y-3">
                  <div className="flex items-center gap-2.5 text-[#e3bd51]">
                    ...
                    <span className="font-bold text-lvl-footer uppercase tracking-wider text-white">OUTILS DE POINTE</span>
                  </div>
                  <p className="text-white/60 text-lvl-footer font-light">
                ...
                <div className="bg-[#121418] border border-white/10 p-6 rounded-none space-y-3">
                  <div className="flex items-center gap-2.5 text-[#e3bd51]">
                    ...
                    <span className="font-bold text-lvl-footer uppercase tracking-wider text-white">CERCLE ALUMNI</span>
                  </div>
                  <p className="text-white/60 text-lvl-footer font-light">
